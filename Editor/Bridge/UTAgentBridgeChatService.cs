...
namespace UTAgent.Editor.Bridge
{
    ...
    public sealed class UTAgentBridgeChatService
    {
        ...
        private bool EnsureRunnerConfigured(out string error)
        {
            ...
            string apiKey = MigratePrefString("UTAgent.Agent_ApiKey", "PythonBridge.Agent_ApiKey");
            ...
            string baseUrl = MigratePrefString("UTAgent.Agent_BaseURL", "PythonBridge.Agent_BaseURL");
            string model = MigratePrefString("UTAgent.Agent_Model", "PythonBridge.Agent_Model", "gpt-4o-mini");
            int maxSteps = MigratePrefInt("UTAgent.Agent_MaxSteps", "PythonBridge.Agent_MaxSteps", 25);
        ...
        private static int MigratePrefInt(string newKey, string oldKey, int defaultValue)
        {
            ...
            {
                return EditorPrefs.GetInt(oldKey, defaultValue);
            }
