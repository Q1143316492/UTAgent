...
namespace UTAgent.Editor.Bridges
{
    public sealed partial class UTAgentPythonBridge
    {
        ...
        /// <summary>
        /// 沿方向向量平移对象（方向归一化后乘以 distance，世界空间）。
        /// </summary>
        ...
        public string RotateObject(string name, string axis, float angle)
        {
            ...
            switch (axis?.ToLowerInvariant())
            {
                ...
                case "z":
                    ...
                    break;
                default:
                    return Error($"不支持的轴：{axis}，必须是 x/y/z");
            }
        ...
        /// <summary>
        /// 使对象朝向目标。usePosition 为 true 时按世界坐标 (tx,ty,tz)；否则 targetName 为另一对象名。
        /// </summary>
            ...
            bool usePosition)
        {
            ...
            else
            {
                ...
                {
                    return Error("target 必须是非空对象名或坐标三元组");
                }
        ...
        /// <summary>
        /// 立即销毁 GameObject（Edit Mode 安全：DestroyImmediate）。
        /// </summary>
