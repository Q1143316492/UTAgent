...
namespace UTAgent.Editor.PythonInterop
{
    public sealed partial class UTAgentPythonBridge
    {
        ...
        /// <summary>
        /// 按名查找一个激活的 GameObject（GameObject.Find；重名时只返回第一个）。
        /// </summary>
        ...
        /// <summary>
        /// 在当前活动场景中按名收集全部 GameObject（含层级、含未激活）。
        /// </summary>
        ...
        /// <summary>
        /// 销毁当前活动场景中全部同名 GameObject（Edit Mode 使用 DestroyImmediate）。
        /// </summary>
